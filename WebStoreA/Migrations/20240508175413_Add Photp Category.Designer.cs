...
namespace WebStoreA.Migrations
{
    ...
    [Migration("20240508175413_Add Photp Category")]
    partial class AddPhotpCategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebStoreA.Data.Entities.Identity.RoleEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("WebStoreA.Data.Entities.Identity.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("WebStoreA.Data.Entities.Identity.UserEntity", null)
                        .WithMany()
